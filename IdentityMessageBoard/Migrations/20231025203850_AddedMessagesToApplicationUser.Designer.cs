...
namespace IdentityMessageBoard.Migrations
{
    ...
    [Migration("20231025203850_AddedMessagesToApplicationUser")]
    partial class AddedMessagesToApplicationUser
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("IdentityMessageBoard.Models.Message", b =>
                {
                    b.HasOne("IdentityMessageBoard.Models.ApplicationUser", "Author")
                        ...
                        .HasConstraintName("fk_messages_application_user_author_id");
